...
import { Aperture, ArrowRight, Mail, User, Lock, Camera } from 'lucide-react'
    ...
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden" style={{ background: '#1a0f0a' }}>
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/50 mt-2">Create your studio account.</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleEmailSignup}>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="John"
                  className="w-full border border-white/10 rounded-xl py-3 pl-9 pr-3 text-white placeholder:text-white/20 focus:outline-none focus:ring-1 transition-all"
          ...
          >
            {loading ? 'Creating account...' : `Create ${role === 'creator' ? 'Creator' : 'Client'} Account`}
        ...
        <p className="text-center text-sm text-white/40 mt-8">
          ...
          <Link href="/login" className="text-white hover:opacity-80 font-medium transition-opacity">
            Sign in
          </Link>
        </p>
      </motion.div>
