...
import { Aperture, LayoutDashboard, ImageIcon, CalendarDays, FileText, MessageSquare, Sparkles, LogOut, Menu, X } from 'lucide-react'
import { motion, AnimatePresence } from 'framer-motion'
import { useAuth } from '@/hooks/use-auth'

const NAV_ITEMS = [
  { name: 'Overview', href: '/client/dashboard', icon: LayoutDashboard },
  { name: 'My Galleries', href: '/client/galleries', icon: ImageIcon },
  { name: 'Messages', href: '/client/messages', icon: MessageSquare },
  { name: 'Event Schedule', href: '/client/schedule', icon: CalendarDays },
