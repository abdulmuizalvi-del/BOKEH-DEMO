        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          <div className="relative w-full md:w-64">
            ...
            <input 
              ...
              className="w-full bg-card border border-white/10 rounded-lg py-2 pl-9 pr-4 text-sm focus:outline-none focus:border-fuchsia-500 transition-colors"
            />
          </div>
            ...
            <Link key={project.id} href={`/projects/${project.id}`}>
              ...
              >
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  <span className={`
                    text-[10px] uppercase tracking-wider font-bold px-2 py-1 rounded backdrop-blur text-white
                    ${project.status === 'IN_PROGRESS' ? 'bg-amber-500/40 border border-amber-500/50 text-amber-100' : 'bg-green-500/40 border border-green-500/50 text-green-100'}
                  `}>
